...
> **DRAFT — written by Ace from the NBER working paper (rev. Jan 2022). For Cindy to verify, correct, and sharpen — especially "referee pushback," which is inferred from the paper's discussion, not known.**
...
TODO: 2–4 classic papers the brief should find (adverse-selection canon — e.g., EFC 2010; Einav & Finkelstein 2011 handbook; HKK 2015), 1–2 frontier papers.
